//TODO игнорирование регистра букв в качестве параметра
//Удаленную загрузку словаря по ссылке
//Автоматический перевод всего в теге, то есть задаю теги, которые должны быть переведены или задаю один тег и говорю, что все в нем должно быть переведено, автоматом проставляет классы.
//темплейтный сайт для показа перевода.
